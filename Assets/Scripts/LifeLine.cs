...
public class LifeLine : MonoBehaviour
{
    ...
    private Color e = (Color) new Color32(0, 98, 191, 255);
    ...
    void Update()
    {
        ...
        if (changed) {
            ...
            e = e1 / Mathf.Pow((float)(e1.r * 0.3 + e1.g * 0.59 + e1.b * 0.11), 0.5f) * Mathf.Pow(2.0f, 2.8f);
            changed = false;
        }

        float t = Mathf.Abs(Mathf.Sin(Time.time * (Mathf.PI / period)));


        foreach (Renderer r in gameObject.GetComponentsInChildren<Renderer>())
        {
            r.material.SetColor("_EmissionColor", e * (0.9f + t * 0.1f));
        ...
        {
            r.material.SetColor("_EmissionColor", e * 0.1f);
        }
